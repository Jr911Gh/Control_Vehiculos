...
public class Inicio extends javax.swing.JFrame {
 ...
 public void confirmarSalida(){
    ...
    private void btn_ingresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ingresoActionPerformed
        ...
        String Usuario ="Admin"; //String para que al momento de ingresar el User sea Admin por defecto
        String Contrasena ="12345"; //String para contraseña para que sea por defecto 12345

        String Pass=new String(txt_contrasena1.getPassword()); //Se valida para que al momento de ingresa la contraseña
                                                                //se convierta en texto
        
        Usuario = this.txt_usuario1.getText();
        Contrasena = this.txt_contrasena1.getText();
