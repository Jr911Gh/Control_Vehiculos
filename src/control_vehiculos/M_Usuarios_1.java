 ...
 */
public class M_Usuarios_1 extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jTextField1.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Ingrese el codigo del usuario","Advertencia",
            JOptionPane.INFORMATION_MESSAGE);
        }else{
            if(jTextField2.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Ingrese el nombre del usuario","Advertencia",
                JOptionPane.INFORMATION_MESSAGE);
            }else{
                if(jTextField3.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Ingrese la clave del usuario","Advertencia",
                    JOptionPane.INFORMATION_MESSAGE);
                }else{   
                        ...
                        sql="INSERT INTO usuariosInt (cod_usuario,Nombre_usuario,Clave_usuario) VALUES (?,?,?)";
                        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_Usuarios_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_Usuarios_1().setVisible(true);
            }
        });
    }
